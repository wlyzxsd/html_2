            ...
            <Container maxWidth='xl'>
                <StyledToolbar>
                    ...
                    <Box sx={{display: {xs: 'none', md: 'flex'}}}>
                        ...
                        <Button variant={active === '3' ? 'contained' : 'text'} color="info" size="medium">Контакты</Button>
                    </Box>
                        ...
                        <Drawer anchor="top" open={open} onClose={toggleDrawer(false)}>
                            <Box>
                                ...
                                <MenuList>
                                    ...
                                    <MenuItem sx={ active === '3' ? { bgcolor: 'info.main', '&:hover' : {bgcolor: 'info.dark'}} : {'&:hover' : {bgcolor: 'lightblue'}}}>Контакты</MenuItem>
                                </MenuList>
                            </Box>
                        </Drawer>
                    </Box>
